...
public class HandleVinOnConnectUseCaseImpl implements HandleVinOnConnectUseCase {
    ...
    @Override
    public void execute(Integer carId, String vin, String deviceId, Callback callback) {
    ...
    public void run() {
        ...
        Disposable disposable = carRepository.get(this.carId, Repository.DATABASE_TYPE.BOTH)
