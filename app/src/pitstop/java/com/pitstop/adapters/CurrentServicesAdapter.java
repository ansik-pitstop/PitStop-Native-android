...
public class CurrentServicesAdapter extends RecyclerView.Adapter<CurrentServicesAdapter.ViewHolder> {
    ...
    public CurrentServicesAdapter(CurrentServicesFragment currentServicesFragment, Car dashboardCar, List<CarIssue> carIssues, Activity activity) {
        this.currentServicesFragment = currentServicesFragment;
