 ...
 * the License.
 */
package com.pitstop.bluetooth.elm.commands.engine;

import com.pitstop.bluetooth.elm.commands.temperature.TemperatureCommand;
...
public class OilTempCommand extends TemperatureCommand {
     ...
     * Copy ctor.
     *
     * @param other a {@link com.pitstop.bluetooth.elm.commands.engine.OilTempCommand} object.
     */
