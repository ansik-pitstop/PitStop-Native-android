 ...
 */
public class EnvironmentalCheckActivity extends AppCompatActivity  implements BluetoothManage.BluetoothDataListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BluetoothManage.getInstance(EnvironmentalCheckActivity.this)
