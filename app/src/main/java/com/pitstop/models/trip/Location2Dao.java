...
/** 
 * DAO for table "LOCATION2".
*/
public class Location2Dao extends AbstractDao<Location2, Long> {

    public static final String TABLENAME = "LOCATION2";
    ...
    public Location2Dao(DaoConfig config) {
        super(config);
    }
    
    public Location2Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LOCATION2\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOCATION2\"";
        db.execSQL(sql);
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM LOCATION2 T");
